...
namespace Bison.Framework.Extensions
{
    public static class SpriteBatchExtensions
    {
        ...
        /// <returns>The next position on the line to draw text. This value uses position.Y and position.X plus the equivalent of calling spriteFont.MeasureString on value.ToString(CultureInfo.InvariantCulture).</returns>  
        public static Vector2 DrawInt64WithLeaderingZeros(this SpriteBatch spriteBatch, SpriteFont spriteFont, int value, Vector2 position, Color color, int numberLength)
        {
            if (spriteBatch == null) throw new ArgumentNullException("spriteBatch");
            if (spriteFont == null) throw new ArgumentNullException("spriteFont");
        ...
        /// <param name="numberLength">The length of the number.</param>  
        /// <returns>The next position on the line to draw text. This value uses position.Y and position.X plus the equivalent of calling spriteFont.MeasureString on value.ToString(CultureInfo.InvariantCulture).</returns>  
        public static Vector2 DrawInt64WithLeaderingZeros(this SpriteBatch spriteBatch, SpriteFont spriteFont, long value, Vector2 position, Color color, int numberLength)
        {
            if (spriteBatch == null) throw new ArgumentNullException("spriteBatch");
            if (spriteFont == null) throw new ArgumentNullException("spriteFont");
        ...
        {
            spriteBatch.DrawInt64WithLeaderingZeros(font,
                                  number,
                                  location + Border1,
                                  borderColor,
                                  zeros);
            ...
            return spriteBatch.DrawInt64WithLeaderingZeros(font,
                                  number,
                                  location,
                                  color,
                                  zeros);
